"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[139],{6667:function(e,t,r){r.d(t,{C:function(){return tr},X:function(){return eB},aa:function(){return e8},ab:function(){return e7},b:function(){return ta},c:function(){return tL},o:function(){return rc},q:function(){return te},y:function(){return tt}});var i,n=r(9279),s=r(3943),a=r(9053),o=r(1735),l=r(2680);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function te(e,t){return(0,s.m9)(e).setPersistence(t)}function tt(e,t,r,i){return(0,s.m9)(e).onAuthStateChanged(t,r,i)}function tr(e){return(0,s.m9)(e).signOut()}new WeakMap;let ti="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
